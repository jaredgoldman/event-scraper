...
const deduplicateEvents = (
  events: z.infer<typeof scrapedEventSchema>[]
): z.infer<typeof scrapedEventSchema>[] => {
...
export const scrapedEventsSchema = z
  .array(scrapedEventSchema)
  .transform(deduplicateEvents)
